					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<center><a class="btn btn-info" href="fecalysis_form.php?itr_no=<?php echo $f['itr_no'] ?>&fecalysis_id=<?php echo $f['fecalisys_id'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
										<center>
								</td>
							</tr>
						<?php

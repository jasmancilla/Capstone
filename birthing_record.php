					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<center><a class="btn btn-info" href="birthing_form.php?itr_no=<?php echo $f['itr_no'] ?>&birth_id=<?php echo $f['birth_id'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
										<center>
								</td>
							</tr>
						<?php

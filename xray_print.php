...
<body>
	...
	<div id="print">
		<div style="margin:10px;">
			<img src="images/loogo.png" height="100px" width="100px" style="float:left; margin-left:90px; margin-top:-15px;" />
			<div style="margin-right:190px;">
				<label>
					<center>REPUBLIKA ng PILIPINAS</center>
				</label>
				<label>
					<center>Probinsya ng Batangas</center>
				</label>
				<label>
					<center>LUNGSOD NG SAN LUIS</center>
				</label>
				<label>
			...
			<label style="font-weight:bold;">
				<center>RADIOLOGICAL / ULTRASONOLOGICAL REPORT</center>
			</label>
			...
			<label style=" margin-bottom:0; float:right;">
				...
				?>
				<br /><label>
					<center>Radiologist / Sonologist</center>
				</label></label>
		</div>
	</div>
	<script>

...
<body>
	...
	<div id="print">
		<div style="margin:10px;">
			<img src="images/loogo.png" height="100px" width="100px" style="float:left; position:relative; left:15%;" />
			...
			<br />
			<label>
				<center><b>PHYSICAL MEDICINE AND REHABILITATION CENTER</b></center>
			</label>
			<label style="font-size:14px;">
				<center>Center Based and Community Based Rehabilitation Program</center>
			</label>
			<br />
			...
			<br />
			<label>
				<center><u><b>PT NOTES</b></u></center>
			</label>
			<br />
			<br />

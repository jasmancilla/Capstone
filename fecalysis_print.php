...
<body>
	...
	<div id="print">
		<div style="margin:10px;">
			<center><label>SAN LUIS CLINICAL LABORATORY</label></center>
			<center><label style="font-size:12px;">HEALTH CENTER OF SAN LUIS</label></center>
			<br />
			<br />
			...
			<br />
			<br />
			<label style="border-top:1px solid #000; margin-left:40px; float:left;">
				<center><?php echo $f['pathologist'] ?></center>
				<label>
					<center><b>Pathologist</b></center>
				</label>
			</label>
			<label style="float:right; margin-top:-15px; margin-right:70px;">
				<center>
					<?php
					...
					?>,RMT</center>
				<label>
					<center><b>MEDICAL TECHNOLOGIST</b></center>
				</label>
			</label>
		</div>
	</div>

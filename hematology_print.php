	...
	<div id="print">
		<div style="margin:10px;">
			...
			<label style="font-size:20px;">
				<center>HEMATOLOGY</center><label>
					...
					<br />
					<br />
					<label style=" float:left; position:relative; left:5%; top:-40px; border-top:1px solid #000; clear:both; font-size:14px;"><b>
							<center><?php echo $f['pathologist'] ?></center>
						</b>
						<br /><label style="font-size:12px; position:relative; top:-10px;">
							<center>Pathologist</center>
						</label></label>
					<label style=" float:right; right:20%; position:relative; top:-80px; clear:both; font-size:14px;">
						<center>
							<?php
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							?>,RMT</center><label style="font-size:12px;">

					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<center><a class="btn btn-info" href="prenatal_form.php?itr_no=<?php echo $f['itr_no'] ?>&prenatal_no=<?php echo $f['prenatal_no'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
										<center>
								</td>
							</tr>
						<?php

...
<body>
	...
	<div id="print">
		<div style="margin:10px;">
			<br />
			<img src="images/loogo.png" style="float:left; margin-top:-20px; margin-left:50px;" height="100px" width="100px">
			<div style="float:left; margin-left:50px;">
				<label>
					<center>SAN LUIS DIAGNOSTIC LABORATORY</center>
				</label>
				<label style="font-size:14px;">
					<center>City Health Office - San Luis</center>
				</label>
				<label style="font-size:18px;">
					<center><b>URINALYSIS</b></center>
				</label>
			</div>
			<br />
			<br />
			...
			<br />
			<br />
			<label style="font-size:14px; position:relative; float:left; left:10%;">
				<center>
					<?php
			...
			<label style="font-size:14px; position:relative; float:left; left:13%;">
				<center>
					<?php
					if ($f['age'] == "") {
						echo "<u>
			...
			<label style="font-size:14px; position:relative; float:left; left:14%;">
				<center>
					<?php
					if ($f['gender'] == "") {
						echo "<u>
			...
			<label style="font-size:14px; position:relative; float:left; left:18%;">
				<center>
					<?php
			...
			<br />
			<br style="clear:both;" />
			<label style=" float:left; margin-left:70px; border-top:1px solid #000; font-size:14px;"><b>
					<center><?php echo $f['pathologist'] ?></center>
				</b>
				<br><label style="position:relative; top:-15px;">
					<center>Pathologist</center>
				</label>
			</label>
			<label style=" float:left; margin-left:300px; font-size:14px;"><b>
					<center>
						<?php
				...
				<br />
				<center><label style="position:relative; top:-15px;">MEDICAL TECHNOLOGIST</label></center>
			</label>
		</div>
	</div>
	<script>

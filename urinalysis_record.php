					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<center><a class="btn btn-info" href="urinalysis_form.php?itr_no=<?php echo $f['itr_no'] ?>&urinalysis_id=<?php echo $f['urinalysis_id'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
										<center>
								</td>
							</tr>
						<?php

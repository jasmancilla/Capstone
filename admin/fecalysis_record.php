			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<center><a href="fecalysis_form.php?itr_no=<?php echo $f['itr_no'] ?>&fecalysis_id=<?php echo $f['fecalisys_id'] ?>" class="btn btn-info"><span class="glyphicon glyphicon-search"></span> View Detail</a>
								<center>
						</td>
					</tr>
				<?php

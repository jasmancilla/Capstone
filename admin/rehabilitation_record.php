			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<center><a class="btn btn-info" href="rehabilitation_form.php?itr_no=<?php echo $f['itr_no'] ?>&rehab_id=<?php echo $f['rehab_id'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
								<center>
						</td>
					</tr>
				<?php

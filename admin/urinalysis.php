				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<center><a class="btn btn-primary" href="urinalysis_record.php?itr_no=<?php echo $fetch['itr_no'] ?>"><span class="glyphicon glyphicon-search"></span> All Records</a></center>
							</td>
						</tr>
					<?php
					}

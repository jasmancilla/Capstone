			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<center><a class="btn btn-info" href="dental_form.php?itr_no=<?php echo $f['itr_no'] ?>&dental_no=<?php echo $f['dental_no'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
								<center>
						</td>
					</tr>
				<?php

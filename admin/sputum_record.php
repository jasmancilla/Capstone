			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<center><a class="btn btn-info" href="sputum_form.php?itr_no=<?php echo $f['itr_no'] ?>&sputum_id=<?php echo $f['sputum_id'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
								<center>
						</td>
					</tr>
				<?php

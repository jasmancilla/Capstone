...
<body>
	...
	<div id="content">
		...
		<div class="panel-body">
			<div class="alert alert-info">Basic Information<a class="btn btn-success" style="float:right; margin-top:-7px;" href="prenatal_record.php?itr_no=<?php echo $_GET['itr_no'] ?>"><span class="glyphicon glyphicon-hand-right"></span> Back</a></div>
		</div>

			...
			<tbody>
				...
				?>
					<tr>
						...
						<td>
							<center><a class="btn btn-info" href="xray_form.php?itr_no=<?php echo $f['itr_no'] ?>&rad_id=<?php echo $f['rad_id'] ?>"><span class="glyphicon glyphicon-search"></span> View Detail</a>
								<center>
						</td>
					</tr>
				<?php
